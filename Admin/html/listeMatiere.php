          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="formMatiere.php" class="btn btn-primary">Nouvelle matiere</a>
              </div>            
                ...
                if (isset($_POST['action'])) {
                  $mc = $_POST['motcle'];
                  $req_recuperation = "SELECT * FROM matiere WHERE IDMATIERE ='$mc' OR LIBELLE ='$mc' ";
                } else {
                  $req_recuperation = "SELECT * FROM matiere   LIMIT $start_from,$nombre_page";
                }
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                   ...
                   echo "<tr>";
                    echo "<td>" . $ligne['IDMATIERE'] . "</td>";
                    echo "<td>" . $ligne['LIBELLE'] . "</td>";
                    echo "<td>" . $ligne['COEFFICIENT'] . "</td>";
                    echo "<td>" . $ligne['ID_CLASS_MAT'] . "</td>";
                    echo '<td><a href="updateMatiere.php?id=' . $ligne['IDMATIERE'] . '" class="btn btn-primary"><i class="bi bi-pencil-fill"></i></a></td>';
                    // echo '<td><a href="Details/detailsMatiere.php?id=' . $ligne['IDMATIERE'] . '" class="btn btn-dark"><i class="bi bi-eye-fill"></i></a></td>';
                    echo '<td><a href="Delete/deleteMatiere.php" class="btn btn-danger delete-btn" data-id="' . $ligne['IDMATIERE'] . '"><i class="bi bi-trash3-fill"></i></a></td>';
                    echo "</tr>";
                    }
                      ?>
                  </tbody>
              ...
              if ($page > 1) {
                echo "<a href='listeMatiere.php?page=" . ($page - 1) . "' class='btn btn-primary' id='bouton_page2'> << </a>";
              }

              for ($i = 1; $i < $total_page+1; $i++) {
                if ($page != $i) {
                  echo "<a href='listeMatiere.php?page=" . $i . "' class='btn btn-primary' id='bouton_page'>$i</a>";
                } else {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        deleteButtons.forEach(button => {
            button.addEventListener("click", function(event) {
                ...
                if (confirmDelete) {
                    window.location.href = "./Delete/deleteMatiere.php?id=" + id;
                }
            });
        });
    });
