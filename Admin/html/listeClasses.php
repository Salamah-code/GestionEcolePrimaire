    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4 text-center">LISTE DES CLASSES</h5>
              <div class="d-flex justify-content-between align-items-center">
                <a href="imprimer_etudiant.php" class="btn btn-primary"><i class="bi bi-printer"></i></a>
                <a href="formClasse.php" class="btn btn-primary">Nouvelle Classe</a>
                ...
                if (isset($_POST['action'])) {
                  $mc = $_POST['motcle'];
                  $req_recuperation = "SELECT * FROM classe WHERE IDCLASSE ='$mc' OR NOMCLASSE ='$mc' ";
                } else {
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    $resultat = mysqli_query($congestschool, $req_recuperation);
                    if (!$resultat) {
                        die("Erreur MySQL : " . mysqli_error($congestschool));
                    }
                    ...
                    echo "<td>" . $ligne['ANNEACCADEMIQUE'] . "</td>";
                    echo "<td>" . $ligne['EFFECTIF'] . "</td>";
                  
                    echo '<td><a href="updateClasse.php?id=' . $ligne['IDCLASSE'] . '" class="btn btn-primary"><i class="bi bi-pencil-fill"></i></a></td>';
                    echo '<td><a href="detailsClasse.php?id=' . $ligne['IDCLASSE'] . '" class="btn btn-dark"><i class="bi bi-eye-fill"></i></a></td>';
                    echo '<td><a href="Delete/deleteClasse" class="btn btn-danger delete-btn" data-id="' . $ligne['IDCLASSE'] . '"><i class="bi bi-trash3-fill"></i></a></td>';
                    echo "</tr>";
              ...
              if ($page > 1) {
                echo "<a href='listeClasses.php?page=" . ($page - 1) . "' class='btn btn-primary' id='bouton_page2'> << </a>";
              }

              for ($i = 1; $i < $total_page+1; $i++) {
                if ($page != $i) {
                  echo "<a href='listeClasses.php?page=" . $i . "' class='btn btn-primary' id='bouton_page'>$i</a>";
                } else {
              ...
              if ($i > $page) {
                echo "<a href='listeClassesss.php?page=" . ($page + 1) . "' class='btn btn-primary' id='bouton_page2'> >> </a>";
              }
              ?>
            </div>
          </div>
